...
class TestDB(unittest.TestCase):
    ...
    def test_create_connection(self):
        ...
        self.assertIsInstance(conn, db.sqlite3.Connection)
    ...
    def test_close_connection(self):
        ...
        conn = db.create_connection(self.db_file)
        db.close_connection(conn)
        self.assertRaises(db.sqlite3.ProgrammingError,
    ...
    def test_insert_one_row_error(self):
        """Test insert_one_row function.
        """
        sql = """CREATE TABLE IF NOT EXISTS test (
            id integer PRIMARY KEY,
    ...
    def test_insert_many_rows_error(self):
        """Test insert_many_rows function.
        """
        sql = """CREATE TABLE IF NOT EXISTS test (
            id integer PRIMARY KEY,
    ...
    def test_select_many_rows(self):
